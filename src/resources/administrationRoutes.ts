...
export function registerAdministrationRoutesResource(server: McpServer): void {
  server.registerResource(
    ...
    '/resources/administration-routes-guide', // Added missing uriOrTemplate argument
    {
    ...
    async () => {
      try {
        ...
        return createComprehensiveErrorResponse(classifiedError, undefined, {
          toolName: 'administration_routes_guide',
        });
      }
    },
  );
...
async function generateAdministrationRoutesResource(): Promise<any> {
  ...
  try {
    ...
    const resource = {
      ...
      clinical_overview: {
        purpose:
          'Comprehensive guidance for medication administration route selection and implementation',
        ...
        clinical_importance:
          'Route selection significantly impacts therapeutic efficacy, safety, and patient experience',
      },
      ...
      clinical_references: {
        ...
        professional_organizations:
          'Israeli Medical Association and Israeli Pharmacy Association guidelines',
      ...
      contents: [
        {
          ...
          uri: '/resources/administration-routes-guide',
          mimeType: 'application/json',
        },
      ],
      _meta: {
    ...
    const fallbackResource = await generateFallbackAdministrationResource();
    return {
      contents: [
        {
          type: 'text',
    ...
    primary_categories: {
      ...
      inhalation: {
        ...
        clinical_advantages: [
          ...
          'Rapid onset for respiratory conditions',
          'Reduced systemic effects',
        ],
        clinical_limitations: [
          'Technique-dependent',
          'Device requirements',
          'Patient coordination needed',
        ],
