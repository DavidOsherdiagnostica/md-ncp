...
export const API_CONFIG = {
  BASE_URL:
    process.env.ISRAEL_DRUGS_API_BASE_URL ||
    'https://israeldrugs.health.gov.il/GovServiceList/IDRServer',
  IMAGES_BASE_URL:
    process.env.ISRAEL_DRUGS_IMAGES_BASE_URL ||
    'https://mohpublic.z6.web.core.windows.net/IsraelDrugs',
...
export const SAFETY_CONFIG = {
  ...
  DISCLAIMERS: {
    GENERAL:
      'This information is from the Israeli Ministry of Health database. Always consult healthcare professionals for medical decisions.',
    ...
    OUTDATED:
      'Information may not reflect the most recent updates. Verify with current medical sources.',
  },
